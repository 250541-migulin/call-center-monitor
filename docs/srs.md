...
- [3 Системные требования](#3-системные-требования)
  ...
  - [4. Возможности расширения](#4-возможности-расширения)
...
<a name="4-Возможности-расширения"/>

## 4. Возможности расширения
В текущей версии системы поддерживается единый интервал рабочего времени (например, 09:00–18:00) для всех дней недели.  
Однако архитектура системы допускает расширение функционала за счёт введения расписания по дням недели (например, понедельник–пятница: 09:00–18:00, суббота: 10:00–15:00, воскресенье — выходной).  
Такое расширение может быть реализовано в будущем путём модификации таблицы `WorkingHours` и соответствующей логики анализа звонков.

<a name="5-архитектурные-диаграммы"/>

## 5. Архитектурные диаграммы

Проектирование системы выполнено в соответствии с методическими указаниями Лабораторных работ №3–4. Все артефакты хранятся в репозитории и доступны по ссылкам ниже.

### 5.1 Диаграммы предметной области
- [Диаграмма классов](diagrams/class-diagram.png) — статическая структура системы (сущности, атрибуты, методы)
- [ER-диаграмма](diagrams/er-diagram.png) — логическая модель базы данных

### 5.2 Диаграммы поведения
- [Диаграмма активности UC3](use-cases/diagrams/uc3-activity.png)
- [Диаграмма последовательности UC3](use-cases/diagrams/uc3-sequence.png)
- [Диаграмма состояний UC3](use-cases/diagrams/uc3-state.png)
- [Диаграмма активности UC4](use-cases/diagrams/uc4-activity.png)
- [Диаграмма последовательности UC4](use-cases/diagrams/uc4-sequence.png)
- [Диаграмма состояний UC4](use-cases/diagrams/uc4-state.png)

### 5.3 Архитектурные диаграммы
- [Диаграмма компонентов](diagrams/component-diagram.png) — логическое разделение системы на модули
- [Диаграмма развёртывания](diagrams/deployment-diagram.png) — физическое размещение компонентов на узлах